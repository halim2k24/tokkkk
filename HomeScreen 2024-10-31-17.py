        ...
        for obj in ok_objects:
            ...
            for angle in range(0, 360, 10):
                ...
                for angle in range(90, 450, 10):
                    start_x_90, start_y_90 = calculate_positions(center_x, center_y, object_width, picking_box_size, angle, distance)
                    start_x_270, start_y_270 = calculate_positions(center_x, center_y, object_width, picking_box_size, angle + 180, distance)
